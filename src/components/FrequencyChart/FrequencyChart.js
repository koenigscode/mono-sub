...
class FrequencyChart extends Component {
    ...
    /**
     * sort the chart data descending
     */
    get sortedData() {
    ...
    /**
     * Creates the chart
     * @param ctx: context of the canvas for the chart to be drawn on
     */
    createChart(ctx) {
        this.setState({
